      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-slate-500 truncate">Chat with your classmates</p>
          </div>
        </div>

        <div className="bg-white rounded-2xl border border-slate-200/80 overflow-hidden h-[calc(100vh-12rem)] lg:h-[calc(100vh-10rem)]">
          <div className="flex h-full">
            {/* Conversations List */}
            <div className={`w-full md:w-80 border-r border-slate-200 flex flex-col ${activeConv ? 'hidden md:flex' : 'flex'}`}>
                  ...
                  conversations.map((conv) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 transition-colors cursor-pointer text-left border-b border-slate-50 ${
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            <p className={`text-sm font-medium truncate min-w-0 ${isActive ? 'text-teal-700' : 'text-slate-900'}`}>{other.name}</p>
                            {conv.lastMessage && (
                ...
                <>
                  ...
                  <form onSubmit={handleSend} className="p-3.5 border-t border-slate-200 flex gap-2 bg-white">
                    ...
                    <button
                      ...
                      className="px-4 py-2.5 rounded-xl bg-teal-600 text-white hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer shadow-sm transition-all"
                    >
...
function NewChatModal({ onClose, onSelect, currentUserId }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 px-4 rc-scale-in">
